   ...
   template: `
    <div class="flex flex-col gap-6 h-full">
      ...
      <div class="shrink-0 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
           <h1 class="font-display font-black text-3xl text-slate-900 dark:text-white tracking-tight">Gestión de Reuniones</h1>
      ...
      <!-- Tabs Navigation -->
      <div class="shrink-0 flex items-center gap-1 bg-white dark:bg-slate-800 rounded-2xl p-1.5 shadow-sm border border-slate-200/60 dark:border-slate-700/60">
                  ...
                  <div class="flex flex-col md:flex-row items-center justify-between gap-6 mb-8 border-b border-slate-100 pb-6">
                     <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-black text-slate-900 dark:text-white leading-none">Registro de Asistencia Semanal</p>
                        </div>
                     </div>
        ...
        <ng-container *ngIf="activeTab() === 'asignaciones'">
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-200/60 dark:border-slate-700/60 h-full flex items-center justify-center animate-fadeIn">
            <div class="text-center max-w-md">
              ...
              <h3 class="text-2xl font-black text-slate-900 dark:text-white mb-2">Gestión de Asignaciones</h3>
